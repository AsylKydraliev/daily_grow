...
const form = useForm({
    ...
    purchase_price_usd: props.product.purchase_price_usd,
    purchase_price_kzt: props.product.purchase_price_kzt,
    wholesale_price_usd: props.product.wholesale_price_usd,
    wholesale_price_kzt: props.product.wholesale_price_kzt,
    current_quantity: props.product.current_quantity || 0,
})
